...
#include "ui_demandemodifresadialog.h"
...
DemandeModifResaDialog::DemandeModifResaDialog(QWidget *parent, QString ut, QString m, QString pwd)
    : QDialog(parent)
    , ui(new Ui::DemandeModifResaDialog)
{
...
DemandeModifResaDialog::~DemandeModifResaDialog()
{
    delete ui;
}

void DemandeModifResaDialog::afficherHotel(){
    ...
    if(mailCli.isEmpty()){
        ...
        if(!query.exec()){
            ...
            while(query.next()){
                ...
                // Incrementation nombre de colonnes
    ...
    // Si la QLineEdit mail n'est pas vide
    else{
        // Preparation de la requete
...
void DemandeModifResaDialog::on_pushButton_search_clicked()
{
...
void DemandeModifResaDialog::rechercherHotel(const QString& nom, const QString& ville){
    // Ouverture de la connexion a bdd & Preparation de la requete SQL
    db.open();
    QSqlQuery query(db);
    ...
    if(mailCli.isEmpty()){
        ...
        // Si la ville et le mail sont vides
        else if(!nom.isEmpty() && ville.isEmpty()){
            // Preparation de la requete SQL
            QString preparedQuery = "SELECT * "
                                    "FROM hotel "
...
void DemandeModifResaDialog::on_pushButton_val_clicked()
{
    ...
    // Creation instance modifResaDialog
    ModifResaDialog* modifResaDialog = new ModifResaDialog(this, this->userType, this->mail, res, this->mdp);

    // Affichage de l'instance ModifResaDialog
    modifResaDialog->showMaximized();

    // Fermer instance DemandeModifResaDialog
    this->close();
}

void DemandeModifResaDialog::on_accueil_clicked()
{
    ...
    // Fermeture de l'instance DemandeModifResaDialog
    this->close();
}


void DemandeModifResaDialog::on_account_clicked()
{
    ...
    if (clickedButton) {
        ...
        if (clickedButton == btnOui) {
            ...
            // Si l'utilisateur est un employé responsable
